model ColectorSolar "Modelo de colector o captador solar" 
    ...
    <p>
    Modelo de captador solar que implementa la curva de rendimiento según la norma UNE-EN 12975. <br>
    Este modelo considera que el equipo alcanza condiciones estacionarias.<br>
    </p>
    <img src=\"../Imagenes/CurvaCaptador.png\"><br>
    </HTML>"),
...
equation 
  ...
  connect(control_Colector.senalTemperaturaCaptador, temperatureSensor.T) 
    annotation (
      points=[-64.6,64; -76,64; -76,-76; -10,-76; -10,-68],
      style(
        color=74,
        rgbcolor={0,0,127},
        gradient=2));
  ...
  connect(flowPort_a, volumenControlUnico1.flowPort_a) 
    annotation (
      points=[-100,-80; -60,-80; -60,-26; -20,-26],
      style(
        color=1,
        rgbcolor={255,0,0},
        gradient=2));
  connect(volumenControlUnico1.flowPort_b, flowPort_b) 
    annotation (
      points=[0,-26; 50,-26; 50,80; 100,80],
      style(
        color=1,
        rgbcolor={255,0,0},
        gradient=2));
  ...
  connect(perdidasAmbiente.port, volumenControlUnico1.puertoInt) 
    annotation (
      points=[-30,34; -30,20; -10,20; -10,-16],
      style(
        color=42,
        rgbcolor={191,0,0},
        gradient=2));
  connect(factorSombras, control_Colector.factorSombras) 
    annotation (points=[-108,-40; -80,-40; -80,68; -64.8,68],
      style(
        color=74,
        rgbcolor={0,0,127},
        fillColor=9,
