model ControladorSolar "Controlador solar sencillo. Termostato diferencial" 
  ...
  annotation (Diagram, Icon(
      ...
      Polygon(points=[-44,30; 20,14; 20,-16; -44,0; -44,30], style(
          ...
          fillPattern=1))));
  Modelica.Blocks.Interfaces.RealOutput y annotation (extent=[96,-10; 116,10]);
  Modelica.Blocks.Logical.TriggeredTrapezoid triggeredTrapezoid(
    amplitude=0.0001,
    rising=10,
    offset=0.00000001) annotation (extent=[48,0; 68,20]);
  Modelica.Blocks.Math.Add add(k1=+1, k2=-1) 
    annotation (extent=[-60,0; -40,20]);
  Modelica.Blocks.Logical.Hysteresis hysteresis(uLow=DeltaT_off, uHigh=
        DeltaT_on) annotation (extent=[-22,0; -2,20]);
...
equation 
  connect(triggeredTrapezoid.y, y) 
    annotation (points=[69,10; 82,10; 82,0; 106,0],
                                      style(color=74, rgbcolor={0,0,127}));
  connect(add.u1, TempCol) annotation (points=[-62,16; -70,16; -70,60; -100,60],
      style(color=74, rgbcolor={0,0,127}));
