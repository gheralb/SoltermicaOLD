model DemandaValvulas 
  "Modelo en el que se simula la demanda de ACS mediante la apertura de válvulas. Esta es una prueba básica para comporbar la aparación del un caudal ante una diferencia de presión" 
